...
define('VI_WOO_THANK_YOU_PAGE_VERSION', '1.0.12');
/**
    ...
    function global_note()
    {
        if (!is_plugin_active('woocommerce/woocommerce.php')) {
            ...
            <div id="message" class="error">
                <p><?php esc_html_e('Please install and activate WooCommerce to use Thank You Page Customizer for WooCommerce.', 'woo-thank-you-page-customizer'); ?></p>
            </div>
            <?php
